...
const Top_praise_receivers = () => {
    ...
    useEffect(() => {
        if (selectedCategoryId == "All") {
            fetch(`http://64.226.70.3:8001/get_top_praise_receivers/?current_item=0`, {
                method: "GET",
                cache: "no-cache"
            })
            ...
            fetch(`http://64.226.70.3:8001/get_top_praise_receivers/?current_item=0&category_id=${selectedCategoryId}`, {
                method: "GET",
                cache: "no-cache"
            })
                .then(response => response.json())
